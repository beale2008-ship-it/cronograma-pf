...
const CACHE_NAME = "cronograma-pf-v3";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
...
// everything else (like the Google Fonts CSS/files), so the app still works
// offline once fonts have been loaded at least once.
